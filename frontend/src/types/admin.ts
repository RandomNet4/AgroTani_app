...
export type StatusVerifikasi = 'pending' | 'approved' | 'rejected' | 'survey' | 'selesai' | 'selesai_panen';
...
export interface Petani {
  id: string; id_petani?: string; nama: string; nik: string; noHp: string; email: string;
