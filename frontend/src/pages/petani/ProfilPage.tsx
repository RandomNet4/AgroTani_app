...
import { formatPetaniId } from '../../utils/formatters';
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="bg-gradient-to-br from-primary-700 to-primary-800 text-white px-4 py-8 rounded-b-3xl">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-display font-bold text-2xl mb-0.5">{petani.nama}</h1>
            <p className="text-emerald-200 text-xs font-bold mb-1 font-mono">ID: {formatPetaniId(petani.id_petani || petani.id || '')}</p>
            <p className="text-green-100 text-xs mb-2">{petani.kecamatan}, {petani.kabupaten}</p>
