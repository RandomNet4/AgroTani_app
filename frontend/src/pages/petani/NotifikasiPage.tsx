...
const NotifikasiPage: React.FC = () => {
  const { notifikasi: listNotifikasi, readNotifikasi, refreshData } = useData();
              ...
              <div className="flex-1 min-w-0">
                ...
                {!n.dibaca && (
                  <button
                    ...
                    className="mt-3 flex items-center gap-1 text-[10px] font-bold text-primary-600 hover:text-primary-700 transition-colors"
                  >
